...
<script type="text/javascript">
	...
	console.log("정수/정수", result); //모든 숫자를 기본으로 double형으로 다룸(number)
	console.log("소수점 없애기", Math.trunc(result)); //trunc:소수점잘라내기
	console.log("반올림하기", Math.round(result));	//round:반올림
	...
	//비교연산자
	// == === != !== > >= < <=
		//== 타입이 다르더라도 변환 후에 값이 같으면 true (변환은 자동으로 함)
		//=== 타입도 같고 값이 같아야 true
	
	// == 연산자와 === 연산자
	// == 연산자는 값이 타입이 다르더라도 변환 후 같은 값이면 true로 판정한다.
