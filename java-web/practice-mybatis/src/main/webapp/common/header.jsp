...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark my-3">
	<a class="navbar-brand" href="/sample-mybatis/index.jsp">HTA 몰</a>
  	...
  	<ul class="navbar-nav">
    	...
    	<li class="nav-item"><a class="nav-link" href="/sample-mybatis/user/registerform.jsp">회원가입</a></li>
    
    	<!-- 로그인된 경우 사용자이름/로그아웃이 표시된다. -->
    	<li class="nav-item "><a class="nav-link" href="/sample-mybatis/user/detail.jsp"><%=loginedUser.getName() %></a></li>
