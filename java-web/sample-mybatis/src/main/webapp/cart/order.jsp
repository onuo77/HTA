...
<!-- 
	...
	2. 로그인된 사용자만 주문할 수 있다.
		...
		SessionSavedUser가 null이면 ../user/loginform.jsp?fail=deny?job=주문하기를 재요청하게 한다.
	...
	5. 주문이 완료되면 전체 주문금액(할인가격을 기준으로 산출된 금액)의 3%를 포인트로 적립한다.
